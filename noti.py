...
key = '28c84783ab7249d9b2251c0bb4bc525b'
TOKEN = '1135207639:AAFLPlKeeWRMvAHv95tWfJjl_9cetDkV9FY'
MAX_MSG_LENGTH = 300
baseurl = 'https://openapi.gg.go.kr/TninsttInstutM?KEY=' + key
...
def getData(loc_param):
    ...
    for item in items:
        ...
        parsed = item.split('\n')
        try:
            row = parsed[1] + '(' + parsed[2] + ') ' + parsed[8] + ' ' + parsed[3] + ' ' + parsed[5] + ' ' + parsed[
                7] + '\n'
        except IndexError:
            row = item.replace('|', ',')
